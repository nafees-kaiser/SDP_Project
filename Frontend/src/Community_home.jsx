        ...
        <>
            ...
            <div className={style.container}>
                <div className={style.up}>
                    ...
                    {Array.isArray(value.valueCopy)? ( value.valueCopy.map((value) => (
                ...
                <div className={style.down} >
                    <div onClick={imageClick}className={style.imgClick}>
                        ...
                        <div className={style.image}>
                            {img? <img src={URL.createObjectURL(img)} alt=''  />          :<i className="fa-solid fa-circle-plus" style={{ transform: "translate(50%, 27%)" }}></i>}
                        </div>
                    </div>
                    <input
                        name="message"
